...
WebUI.setText(findTestObject('SIGN_UP/input_email'), 'iart6yopmail.com')

WebUI.click(findTestObject('SIGN_UP/button_accept'))

WebUI.verifyMatch(DriverFactory.getWebDriver().findElement(By.xpath('//label[@class="error"]')).getText(), 'Ingresa un email válido', 
    false)
